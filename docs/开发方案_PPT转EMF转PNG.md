...
| # | 任务 | 产出 | 验证方法 |
|---|------|------|----------|
| 9.1 | 编写 `build_exe.spec` | 参考 `emf_to_png.spec` | 编译通过 |
| 9.2 | 打包主程序 | `pyinstaller build_exe.spec` | 生成 `dist/emf2png.exe` |
| 9.3 | 打包 `emf_to_png.exe` 为资源 | 嵌入 exe 到打包中 | exe 能找到内部资源 |
| 9.4 | 裸机测试 | 在无 Python 环境运行 | 完整链路可用 |
| 9.5 | GitHub Release 发布 | 上传 exe 到 Release | 可下载 |

### 阶段 10：GitHub 集成与 CI

| # | 任务 | 产出 | 验证方法 |
|---|------|------|----------|
| 10.1 | 配置 `.gitignore` 最终版 | 排除所有不应上传的文件 | `git status` 整洁 |
| 10.2 | GitHub Actions：Python lint | flake8 / ruff 检查 | CI 绿 |
| 10.3 | GitHub Actions：自动打包 | push tag 自动 PyInstaller + Release | Release 自动创建 |
| 10.4 | GitHub Actions：测试 | 基本功能测试（无 Office 部分） | CI 绿 |

### 阶段 11：文档完善

| # | 任务 | 产出 | 验证方法 |
|---|------|------|----------|
| 11.1 | `README.md` 最终版 | 安装、用法、示例、参数完整 | 检查无误 |
| 11.2 | 添加 `--help` 输出截图 | README 中展示 | 美观 |
| 11.3 | 添加常见问题 FAQ | Office 要求、字体、性能等 | 覆盖常见疑问 |

### 阶段 12：可选高级功能

| # | 任务 | 说明 | 优先级 |
|---|------|------|--------|
| 12.1 | 拖拽式 GUI (Tkinter) | 方便非技术用户 | P2 |
| 12.2 | 批量文件夹处理 | 一次处理多个 PPT | P2 |
| 12.3 | 水印/页眉页脚 | 导出前叠加 | P3 |
| 12.4 | 对比模式（原图 vs PNG） | 质量控制 | P3 |
| 12.5 | 保留原始 EMF 矢量嵌入 | 输出 EMF + PNG 双份 | P3 |
...
阶段 1: CLI 骨架          ██████████ 100%  ✅
阶段 2: EMF→PNG 模块     ██████████ 100%  ✅
阶段 3: PPT→EMF 模块     ░░░░░░░░░░   0%  ◀ 当前
阶段 4: 裁剪白边         ░░░░░░░░░░   0%
阶段 5: 缩放与 DPI       ░░░░░░░░░░   0%
阶段 6: PDF 合并          ░░░░░░░░░░   0%
阶段 7: 进度与 UX         ░░░░░░░░░░   0%
阶段 8: 错误处理          ░░░░░░░░░░   0%
阶段 9: PyInstaller 打包  ░░░░░░░░░░   0%
阶段10: GitHub CI         ░░░░░░░░░░   0%
阶段11: 文档完善          ░░░░░░░░░░   0%
```
